...
#ifndef AST_CONTROL_SEQUENTIAL_STATEMENT_H
#define AST_CONTROL_SEQUENTIAL_STATEMENT_H
...
class ASTControlSequentialStatement : public ASTControlStatement
{
  ...
  public:
    ASTControlSequentialStatement(string label, ParseVector<ASTControlStatement*> items);
